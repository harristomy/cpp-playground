...
// configuration step. It creates a namespace called `cpp_playground`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cpp_playground::cmake::project_name, cpp_playground::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cpp_playground::cmake::project_version);
      return EXIT_SUCCESS;
    }
